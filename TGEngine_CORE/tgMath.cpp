...
namespace tg::math
{
	...
	****************************************************************************/
	...
	static_assert(sizeof(tg::math::Viewport) == sizeof(D3D11_VIEWPORT), "Size mismatch");
	static_assert(offsetof(tg::math::Viewport, x) == offsetof(D3D11_VIEWPORT, TopLeftX), "Layout mismatch");
	static_assert(offsetof(tg::math::Viewport, y) == offsetof(D3D11_VIEWPORT, TopLeftY), "Layout mismatch");
	static_assert(offsetof(tg::math::Viewport, width) == offsetof(D3D11_VIEWPORT, Width), "Layout mismatch");
	static_assert(offsetof(tg::math::Viewport, height) == offsetof(D3D11_VIEWPORT, Height), "Layout mismatch");
	static_assert(offsetof(tg::math::Viewport, minDepth) == offsetof(D3D11_VIEWPORT, MinDepth), "Layout mismatch");
	static_assert(offsetof(tg::math::Viewport, maxDepth) == offsetof(D3D11_VIEWPORT, MaxDepth), "Layout mismatch");
#endif
